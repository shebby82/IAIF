...
CURSOR Policies IS
   ...
   JOIN AsPolicyField FreeLookEndDate ON AsPolicy.PolicyGUID = FreeLookEndDate.PolicyGUID
       AND FreeLookEndDate.FieldName = 'PolicyFreeLookEndDate'
       AND FreeLookEndDate.DateValue >= (SELECT SystemDate FROM AsSystemDate WHERE CurrentIndicator = 'Y')
    WHERE AsPolicy.StatusCode IN ('67', '02', '79', '19')
